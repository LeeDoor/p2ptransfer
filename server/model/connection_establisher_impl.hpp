...
class ConnectionEstablisherImpl : public ConnectionEstablisher, public WithCallback<ConnectionStatusCallback> {
public:
    ConnectionEstablisherImpl(std::shared_ptr<SocketManager> socket_manager) :
        socket_manager_(socket_manager){}
    net::awaitable<void> establish_connection(Port port) override;
