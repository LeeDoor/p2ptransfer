...
public:
    ...
    std::shared_ptr<SocketManagerFactory> create_socket_builder(net::io_context& context) override;
    ...
    void set_socket_builder(std::shared_ptr<SocketManagerFactory> value);
...
private:
    ...
    std::shared_ptr<SocketManagerFactory> socket_manager_factory_ = nullptr;
